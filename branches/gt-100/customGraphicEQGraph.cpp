...
void customGraphicEQGraph::paintEvent ( QPaintEvent *pPaintEvent )
{
    ...
    int b1 = h - (m_iBand_1*4) + 40;
    int b2 = h - (m_iBand_2*4) + 40;
    int b3 = h - (m_iBand_3*4) + 40;
    int b4 = h - (m_iBand_4*4) + 40;
    int b5 = h - (m_iBand_5*4) + 40;
    int b6 = h - (m_iBand_6*4) + 40;
    int b7 = h - (m_iBand_7*4) + 40;
    int b8 = h - (m_iBand_8*4) + 40;
    int b9 = h - (m_iBand_9*4) + 40;
    int b10 = h - (m_iBand_10*4) + 40;
