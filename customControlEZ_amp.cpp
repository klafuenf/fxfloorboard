...
void customControlEZ_amp::LowGainChanged(unsigned short iLowGain)
{
...
void customControlEZ_amp::MidFreqChanged(unsigned short iMidFreq)
{
...
void customControlEZ_amp::MidQChanged(unsigned short iMidQ)
{
...
void customControlEZ_amp::MidGainChanged(unsigned short iMidGain)
{
...
void customControlEZ_amp::HighGainChanged(unsigned short iHighGain)
{
...
void customControlEZ_amp::LevelChanged(unsigned short iLevel)
{
    if(area != "System"){
