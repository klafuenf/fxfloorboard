...
void stompBox::updateSwitch(QString hex1, QString hex2, QString hex3)
{
    ...
    if (this->id == 0) { emit compressor_statusSignal(set); };
    if (this->id == 1) { emit sendreturn_statusSignal(set); };
    ...
    if (this->id == 4) { emit eq_statusSignal(set); };
    if (this->id == 5) { emit fx1_statusSignal(set); };
    if (this->id == 6) { emit fx2_statusSignal(set); };
    if (this->id == 7) { emit delay_statusSignal(set); };
    ...
    if (this->id == 11){ emit pedal_statusSignal(set); };
    if (this->id == 13){ emit ns1_statusSignal(set); };
    if (this->id == 14){ emit ns2_statusSignal(set); };
    if (this->id == 15){ emit distortion_statusSignal(set); };
    if (this->id == 17){
