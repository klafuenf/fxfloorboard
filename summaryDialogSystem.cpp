    ...
    : QWidget(parent)
{
    ...
    if(sysxIO->deviceReady())
    {
        ...
        if (sysxIO->isConnected())
        {
            ...
            sysxIO->sendSysx(systemRequest); // GT-100 System area data Request.
        }
        else
        {
    ...
    text.append("<br><br><b><u>********** CONTROLLER ***********</b></u><br>");
    address1= "00";
    address2= "02";
    start = 80;
    finish = 117;
    ...
    text.append("<br><br><b><u>********** MIDI INPUT/OUTPUT ***********</b></u><br>");
    address1= "02";
    address2= "00";
    start = 0;
    finish = 15;
